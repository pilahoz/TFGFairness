...
nb.fit(COMPAS.processtrain_x, COMPAS.train_y) #Entrenamos el algoritmo de machine learning
#Calculamos el score

score = nb.score(COMPAS.processvalid_x, COMPAS.valid_y) #Devuelve la precisión media en los datos de prueba y las etiquetas dadas
print("The score for this model is ", score)

#Matriz de confusion
pred_y = nb.predict(COMPAS.processvalid_x) #Prediccion
...
y_pred_proba = nb.predict_proba(COMPAS.processvalid_x)[:, 1] # Obtenemos las probabilidades de predicción del modelo para el conjunto de prueba
...
p1_nb = nb.predict_proba(COMPAS.grupo_aa) #probabilidad del grupo_aa
p2_nb = nb.predict_proba(COMPAS.grupo_noaa) #probabilidad del grupo_noaa

#-------PARIDAD-------
umbral_aap, umbral_noaap =Fairness.umbralparidad(COMPAS.grupo_aa, COMPAS.grupo_noaa, p1_nb, p2_nb, min_umbral)
print("umbra aa:",umbral_aap, "umbral noaa:", umbral_noaap)

#columna de prob que si reincidan
ind1 = p1_nb[:,1]>umbral_aap
ind2 = p2_nb[:,1]>umbral_noaap
...
umbral_aaip, umbral_noaaip = Fairness.umbralprobabilidades(COMPAS.grupo_aa, COMPAS.grupo_noaa, p1_nb, p2_nb, nb, COMPAS.valid_yaux1, COMPAS.valid_yaux2, COMPAS.valid_yaux, min_umbral)
print("umbra aa:",umbral_aaip, "umbral noaa:", umbral_noaaip)

ind1ip = p1_nb[:,1]>umbral_aaip #columna de prob que si reincidan
ind2ip = p2_nb[:,1]>umbral_noaaip
...
umbral_aaio, umbral_noaaio = Fairness.umbraloportunidades(COMPAS.grupo_aa, COMPAS.grupo_noaa, p1_nb, p2_nb, nb, COMPAS.valid_yaux1, COMPAS.valid_yaux2, COMPAS.valid_yaux, min_umbral)
print("umbra aa:",umbral_aaio, "umbral noaa:", umbral_noaaio)

ind1io = p1_nb[:,1]>umbral_aaio #columna de prob que si reincidan
ind2io = p2_nb[:,1]>umbral_noaaio
...
#-------IMPACTO DESIGUAL-------
umbral_aaid, umbral_noaaid = Fairness.umbralimpactodesigual(COMPAS.grupo_aa, COMPAS.grupo_noaa, p1_nb, p2_nb, nb, COMPAS.valid_yaux1, COMPAS.valid_yaux2, COMPAS.valid_yaux, min_umbral)
print("umbra aa:",umbral_aaid, "umbral noaa:", umbral_noaaid)

ind1id = p1_nb[:,1]>umbral_aaid #columna de prob que si reincidan
ind2id = p2_nb[:,1]>umbral_noaaid
