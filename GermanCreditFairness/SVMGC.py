...
gssvc.fit(GermanCredit.processtrain_x, GermanCredit.train_y)
...
score = gssvc.score(GermanCredit.processvalid_x, GermanCredit.valid_y)
print("The score for this model is ", score)

#Matriz de confusion

pred_y = gssvc.predict(GermanCredit.processvalid_x) #Prediccion
...
y_pred_proba = gssvc.predict_proba(GermanCredit.processvalid_x)[:, 1] # Obtenemos las probabilidades de predicción del modelo para el conjunto de prueba
...
p1_svc = gssvc.predict_proba(GermanCredit.grupo_h) #Calcula las probabilidades de los grupos
p2_svc = gssvc.predict_proba(GermanCredit.grupo_m)

#-------PARIDAD-------

umbral_hp, umbral_mp =Fairness.umbralparidad(GermanCredit.grupo_h, GermanCredit.grupo_m, p1_svc, p2_svc, min_umbral)
print("umbra h:",umbral_hp, "umbral m:", umbral_mp)

ind1 = p1_svc[:,1]>umbral_hp #columna de prob que si reincidan
ind2 = p2_svc[:,1]>umbral_mp
...
umbral_hip, umbral_mip = Fairness.umbralprobabilidades(GermanCredit.grupo_h, GermanCredit.grupo_m, p1_svc, p2_svc, gssvc, GermanCredit.valid_yaux1, GermanCredit.valid_yaux2, GermanCredit.valid_yaux, min_umbral)
print("umbra h:",umbral_hip, "umbral m:", umbral_mip)

ind1ip = p1_svc[:,1]>umbral_hip #columna de prob que si reincidan
ind2ip = p2_svc[:,1]>umbral_mip
...
umbral_hio, umbral_mio = Fairness.umbraloportunidades(GermanCredit.grupo_h, GermanCredit.grupo_m, p1_svc, p2_svc, gssvc, GermanCredit.valid_yaux1, GermanCredit.valid_yaux2, GermanCredit.valid_yaux, min_umbral)
print("umbra h:",umbral_hio, "umbral m:", umbral_mio)

ind1io = p1_svc[:,1]>umbral_hio #columna de prob que si reincidan
ind2io = p2_svc[:,1]>umbral_mio
...
#-------IMPACTO DESIGUAL-------
umbral_hid, umbral_mid = Fairness.umbralimpactodesigual(GermanCredit.grupo_h, GermanCredit.grupo_m, p1_svc, p2_svc, gssvc, GermanCredit.valid_yaux1, GermanCredit.valid_yaux2, GermanCredit.valid_yaux, min_umbral)
print("umbra h:",umbral_hid, "umbral m:", umbral_mid)

ind1id = p1_svc[:,1]>umbral_hid #columna de prob que si reincidan
ind2id = p2_svc[:,1]>umbral_mid
